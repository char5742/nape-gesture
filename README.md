...
| Trackpad driver出力 | 再構築中。listen-only raw logger、確定logのcapture manifest、厳格analyzer、generated配送provenance、product / diagnostic output target、fail-closed、共通output session / monotonic clockは実装済み。純正fixture由来の各event family adapterとcontract比較は未完了 | [ADR-0036](docs/adr/0036-emulate-trackpad-driver-output-events.md)、[ADR-0037](docs/adr/0037-separate-product-and-diagnostic-event-output.md)、[ADR-0038](docs/adr/0038-trackpad-output-session-and-monotonic-clock.md)、[ADR-0039](docs/adr/0039-strict-trackpad-event-analysis-and-capture-manifest.md) |
