...
| [ADR-0026](0026-runtime-performance-log-evidence.md) | runtime 性能ログと実行主体固定による tap-to-post / CPU 証跡 | Issue #14、Issue #16、runtime、性能、tap-to-post、sample-cpu、PID 同一性 |
