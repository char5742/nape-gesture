...
| [ADR-0017](0017-system-test-scenario-assertion.md) | System Behavior Test dry-run のシナリオ別機械判定 | Issue #9、Issue #10、Issue #16、system-test、readiness matrix、analyze-log |
