...
次の証跡は、最新の機械証跡は証跡取得対象 commit `e22aa52a4565743d1530e6da87f12c5e480515fc` の main、GUI 権限付与後の runtime event 最新成功証跡は main `e153f3cc6d71a7b7882bc7faff3db28ab2bc00b2` 上で再取得した `runtime-event-permission-rerun-main-e153f3c`、最新 GUI computer-use / System Events 画面証跡は main `24f0f7f1026918caa85912ae52b441350f4edd4b` に対して採用します。
...
- GUI アプリ runtime event 最新 root: `artifacts/completion/2026-07-10/runtime-event-permission-rerun-main-e153f3c`
- GUI アプリ runtime event 最新 summary: `artifacts/completion/2026-07-10/runtime-event-permission-rerun-main-e153f3c/summary.md`
- GUI アプリ runtime event 最新 status: `artifacts/completion/2026-07-10/runtime-event-permission-rerun-main-e153f3c/status.json`
- GUI アプリ runtime event 最新 doctor: `artifacts/completion/2026-07-10/runtime-event-permission-rerun-main-e153f3c/doctor/doctor-debug.json`
- GUI アプリ runtime event 最新 Issue コメント: [#16](https://github.com/char5742/nape-gesture/issues/16#issuecomment-4928682003), [#6](https://github.com/char5742/nape-gesture/issues/6#issuecomment-4928682007), [#13](https://github.com/char5742/nape-gesture/issues/13#issuecomment-4928682015)
- GUI アプリ runtime event 旧成功 root: `artifacts/completion/2026-07-09/runtime-event-kill-switch-release-suppression`
- GUI アプリ runtime event 旧成功 summary: `artifacts/completion/2026-07-09/runtime-event-kill-switch-release-suppression/summary.md`
- GUI アプリ runtime event 旧成功 status: `artifacts/completion/2026-07-09/runtime-event-kill-switch-release-suppression/status.json`
- GUI アプリ runtime event 旧成功 doctor: `artifacts/completion/2026-07-09/runtime-event-kill-switch-release-suppression/doctor/doctor-debug.json`
- GUI アプリ runtime event 旧成功 Issue コメント: [#16](https://github.com/char5742/nape-gesture/issues/16#issuecomment-4926725190), [#6](https://github.com/char5742/nape-gesture/issues/6#issuecomment-4926725331), [#12](https://github.com/char5742/nape-gesture/issues/12#issuecomment-4926725580)
...
`runtime-event-permission-rerun-main-e153f3c/status.json` では `status: "success"`、`failureCount: 0` として機械判定できます。
...
同じ artifact root の `summary.md` では、`gesture-drag`、`gesture-wheel`、`kill-switch`、`gesture-wheel-then-kill-switch`、`normal-after-release` が成功し、gesture 系 runtime 性能ログも成功しています。`gesture-drag`、`gesture-wheel`、`gesture-wheel-then-kill-switch` は generated event のみを foreground capture で受信し、未マーク入力漏れは 0 件です。`normal-after-release` は未マーク通常クリック、通常ドラッグ、通常ホイールが foreground capture へ届くことを確認しています。
