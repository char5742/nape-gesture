...
次の証跡は、機械証跡は証跡取得対象 commit `dddb58306f5971dace4527d0457b201827dc4554` の main、GUI 権限復旧導線追加後の runtime event blocker は main `bd9da85`、GUI computer-use 操作証跡は main `f43e217` に対して採用します。
...
- GUI アプリ runtime event blocker root: `artifacts/completion/2026-07-09/runtime-event-gui-permission-main-bd9da85`
- GUI アプリ runtime event blocker summary: `artifacts/completion/2026-07-09/runtime-event-gui-permission-main-bd9da85/summary.md`
- GUI アプリ runtime event blocker status: `artifacts/completion/2026-07-09/runtime-event-gui-permission-main-bd9da85/status.json`
- GUI アプリ runtime event blocker doctor: `artifacts/completion/2026-07-09/runtime-event-gui-permission-main-bd9da85/doctor/doctor-debug.json`
- GUI アプリ runtime event blocker Issue コメント: [#16](https://github.com/char5742/nape-gesture/issues/16#issuecomment-4925792343), [#6](https://github.com/char5742/nape-gesture/issues/6#issuecomment-4925792494), [#12](https://github.com/char5742/nape-gesture/issues/12#issuecomment-4925792711)
...
NAPE_RUNTIME_EVENT_USE_APP_BUNDLE=1 NAPE_RUNTIME_EVENT_ARTIFACT_ROOT=artifacts/completion/2026-07-09/runtime-event-gui-permission-main-bd9da85 sh scripts/collect-runtime-event-evidence.sh
...
`runtime-event-gui-permission-main-bd9da85/status.json` では `status: "blocked"`、`blockerCode: "accessibility.missing"` として機械判定できます。
