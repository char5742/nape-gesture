...
スクリプトは `commands.txt` と `summary.md` を出力し、debug / release build、core tests、app bundle 作成と検証、doctor、benchmark、system-test dry-run、生成スクロール dry-run、fixture 解析、`devices --all --json` を収集します。
