...
次の証跡は、最新の機械証跡は証跡取得対象 commit `e22aa52a4565743d1530e6da87f12c5e480515fc` の main、GUI 権限付与後の runtime event 最新成功証跡は main `e153f3cc6d71a7b7882bc7faff3db28ab2bc00b2` の `runtime-event-main-e153f3c-summary-fix`、最新 GUI computer-use / System Events 画面証跡は main `24f0f7f1026918caa85912ae52b441350f4edd4b` に対して採用します。
...
- GUI アプリ runtime event main 最新 doctor: `artifacts/completion/2026-07-10/runtime-event-main-e153f3c-summary-fix/doctor/doctor-debug.json`
- GUI アプリ runtime event main 最新 Issue コメント: [#16](https://github.com/char5742/nape-gesture/issues/16#issuecomment-4927546598), [#6](https://github.com/char5742/nape-gesture/issues/6#issuecomment-4927548240), [#12](https://github.com/char5742/nape-gesture/issues/12#issuecomment-4927549953), [#13](https://github.com/char5742/nape-gesture/issues/13#issuecomment-4931678237)
...
| doctor 権限・runtimeIdentity | 実利用する `.app` または実行ファイルでの `doctor --probe-hid --benchmark-events ... --json --assert-runtime-ready` | `doctor --json` の `runtimeIdentity`、`runtimeReadiness`、`tccStatus`、`tccStatus.permissionTarget`、`grantRequired`、`targetDeviceDiagnostics`、`settingsValidationIssues`、benchmark 部分、`--assert-runtime-ready` の期待失敗 code、`PermissionRecoveryPresenter` の権限別 System Settings 導線 core test | なし。2026-07-10 時点で `.build/NapeGesture.app` のアクセシビリティと入力監視は許可済み | `machine-evidence-pr59-main-dddb583/doctor-and-performance/`, `runtime-event-main-e153f3c-summary-fix/doctor/doctor-debug.json`, `runtime-event-kill-switch-release-suppression/doctor/doctor-debug.json`, `gui-computer-use-main-f43e217/doctor/doctor-app.json`, [#16 最新コメント](https://github.com/char5742/nape-gesture/issues/16#issuecomment-4927546598), [#13 readiness 訂正コメント](https://github.com/char5742/nape-gesture/issues/13#issuecomment-4931678237) | #11, #13, #15, #16, #74 | `完了` |
