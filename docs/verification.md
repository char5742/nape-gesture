...
- trackpad scrollでcontinuous scroll eventとcompanion gesture eventがenvelope、phase、capture順上の局所系列として対応し、純正実測どおりtimestamp同値を要求していない
...
- AX、対象PID配送、frontmost application分岐、keyboard shortcut fallbackがない
