...
public enum SettingsValidator {
    public static func issues(for settings: MacGestureSettings) -> [SettingsValidationIssue] {
    ...
    public static func isValid(_ settings: MacGestureSettings) -> Bool {
    ...
    private static func validateTargetDevices(_ settings: MacGestureSettings, issues: inout [SettingsValidationIssue]) {
