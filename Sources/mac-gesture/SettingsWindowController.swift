...
final class SettingsWindowController: NSWindowController {
    var onSave: ((MacGestureSettings) -> Void)?
    ...
    init(settings: MacGestureSettings, configPath: String) {
    ...
    private func populate(_ settings: MacGestureSettings) {
    ...
    @objc private func save() {
        ...
        let updated = MacGestureSettings(
