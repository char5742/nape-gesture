...
struct DoctorCommand {
    ...
    private func makeInventory(settings: MacGestureSettings, findings: inout [String]) -> DoctorInventory {
        do {
    ...
    private func remediation(for error: Error) -> String? {
        ...
        case kIOReturnNotPermitted:
            return "システム設定 > プライバシーとセキュリティ > 入力監視で、Codex、実行元ターミナル、または MacGesture.app を許可してから再起動してください。"
